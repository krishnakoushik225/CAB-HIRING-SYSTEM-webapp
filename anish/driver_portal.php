...
<body>
    <h1 style="margin-top: 50px; margin-left: 590px;">Welcome, Driver!</h1>
    ...
    <div style="background-color: #f6f5f7; width: 100%; height: 20px; margin-top: 10px;">
        <h4 style="margin-top: 30px; margin-right: 690px; color: gray; float: right;"> Booking Requests</h4>
    </div>
    ...
    <div style="background-color: #f6f5f7; width: 100%; height: 20px; margin-top: 30px;">
        <h4 style="margin-top: 30px; margin-left: 380px; color: gray; float: left;"> Report an issue</h4>
